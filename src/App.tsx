...
function AppIcon({ color = "currentColor", size = 18 }: { color?: string; size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M13.0976 12.5C13.3326 12.5 13.5337 12.6632 13.5683 12.8955C13.7966 14.425 14.208 18.5864 15.1963 18.7686C16.881 19.0784 18 19.6262 18 20.25C18 21.2165 15.3137 22 12 22C8.68642 22 6 21.2165 6 20.25C6 19.6262 7.11934 19.0785 8.80371 18.7686C9.79204 18.5863 10.2032 14.4251 10.4316 12.8955C10.4663 12.6633 10.6675 12.5001 10.9023 12.5H13.0976Z" fill={color}/>
      <path d="M2.14462 18.4462C2.44275 18.0194 3.1038 17.8736 3.6202 18.12C4.13677 18.3667 5.24837 19.3583 4.95028 19.7851C4.652 20.2118 3.05659 19.9123 2.54013 19.6659C2.02389 19.4195 1.84669 18.873 2.14462 18.4462Z" fill={color}/>
      <path d="M20.3799 18.12C20.8963 17.8736 21.5573 18.0194 21.8555 18.4462C22.1536 18.8731 21.9764 19.4195 21.4599 19.6659C20.9431 19.9123 19.3479 20.2118 19.0498 19.7851C18.7522 19.3583 19.8632 18.367 20.3799 18.12Z" fill={color}/>
      <path fillRule="evenodd" clipRule="evenodd" d="M12 2C12.414 2.00026 12.75 2.33595 12.75 2.75V3H17.75C19.2688 3 20.5 4.23122 20.5 5.75V5.91992C21.0909 6.20091 21.5 6.80213 21.5 7.5V8.5C21.5 9.19772 21.0907 9.79804 20.5 10.0791V12.25C20.5 14.8734 18.3733 17 15.75 17H15.2812C15.2287 16.81 15.1759 16.5993 15.126 16.3701C14.8959 15.3137 14.7402 14.0809 14.6201 13.1982C14.634 13.2028 14.6482 13.2073 14.6621 13.2119C15.055 13.3429 15.4803 13.1302 15.6113 12.7373C15.7423 12.3443 15.5297 11.919 15.1367 11.7881C12.9825 11.0703 11.0165 11.0702 8.8623 11.7881C8.46956 11.9192 8.25682 12.3445 8.38769 12.7373C8.51864 13.1302 8.94403 13.3427 9.33691 13.2119C9.35081 13.2073 9.36503 13.2028 9.3789 13.1982C9.2587 14.0809 9.10421 15.3138 8.87402 16.3701C8.82406 16.5994 8.77047 16.81 8.71777 17H8.25C5.62678 16.9998 3.5 14.8733 3.5 12.25V10.2373C2.90936 9.95621 2.50001 9.35586 2.5 8.6582V7.5C2.5 6.80218 2.90915 6.20093 3.5 5.91992V5.75C3.5 4.23131 4.73135 3.00015 6.25 3H11.25V2.75C11.25 2.33588 11.5859 2.00015 12 2ZM9.25 6.75C8.4217 6.75015 7.75 7.42167 7.75 8.25C7.75 9.07833 8.4217 9.74985 9.25 9.75C10.0784 9.75 10.75 9.07843 10.75 8.25C10.75 7.42157 10.0784 6.75 9.25 6.75ZM14.75 6.75C13.9217 6.75015 13.25 7.42167 13.25 8.25C13.25 9.07833 13.9217 9.74985 14.75 9.75C15.5784 9.75 16.25 9.07843 16.25 8.25C16.25 7.42157 15.5784 6.75 14.75 6.75Z" fill={color}/>
      <path d="M13.8105 14.0186H13.8047C13.813 14.0163 13.8223 14.0146 13.8223 14.0146C13.8196 14.0154 13.8147 14.0174 13.8105 14.0186Z" fill={color}/>
    </svg>
  );
}
